  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl shadow-lg p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Invoice Templates</h2>
        <p className="text-gray-600 mb-6">Professional invoice templates for billing.</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="border-2 border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 text-sm mb-4">Basic invoice template</p>
