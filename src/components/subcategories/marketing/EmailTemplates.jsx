  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <p className="text-gray-600 mb-6">Professional email marketing campaign templates.</p>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="border-2 border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            <h3 className="font-semibold text-lg mb-2">Newsletter</h3>
            <p className="text-gray-600 text-sm mb-4">Monthly company newsletter</p>
          ...
          <div className="border-2 border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600 text-sm mb-4">Sales and promotion emails</p>
            <button className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition-colors">Use Template</button>
          </div>
        </div>
      </div>
